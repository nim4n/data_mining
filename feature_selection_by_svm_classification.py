...
df.to_pickle('processed_data/rank_svm_classification_dataframe.pd')
print count

df = pd.read_pickle('processed_data/rank_svm_classification_dataframe.pd')
corr_df = df.corr()
removed_columns = []
exist_columns = []
...
df.to_pickle('processed_data/rank_svm_classification_dataframe_remove_relation.pd')
print df.shape
